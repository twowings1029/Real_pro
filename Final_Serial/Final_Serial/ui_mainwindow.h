...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Women_button = new QRadioButton(groupBox);
        Women_button->setObjectName(QStringLiteral("Women_button"));
        Women_button->setGeometry(QRect(10, 50, 90, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Women_button->setText(QApplication::translate("MainWindow", "Woman", Q_NULLPTR));
